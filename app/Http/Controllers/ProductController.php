...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($product_save){
            ...
            $response =APIHelpers::createAPIResponse(true,400,'Create product failed',null);
    ...
    public function update(Request $request, $id)
    {
        ...
        if($product_updated){
            ...
            $response =APIHelpers::createAPIResponse(true,400,'Update product failed',null);
            return response()->json($response,400);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if($product_deleted){
            ...
            $response =APIHelpers::createAPIResponse(true,400,'Delete product failed',null);
            return response()->json($response,400);
        }
    }
}
